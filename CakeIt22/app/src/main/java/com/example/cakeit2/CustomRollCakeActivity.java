...
public class CustomRollCakeActivity extends AppCompatActivity {

    // Hidden textviews as variable
    TextView selectedSize, selectedsponge, selectedfilling, selectedfrosting,
            selectedtoppings, selectedcandles;

    EditText candles;
    RadioGroup size, sponge, filling, frosting, toppings;
    RadioButton size6, size8, size10, size12, size14, size16,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_roll_cake);
        ...
        size8 = findViewById(R.id.rbSize8);
        size10 = findViewById(R.id.rbSize10);
        size12 = findViewById(R.id.rbSize12);
        size14 = findViewById(R.id.rbSize14);
        size16 = findViewById(R.id.rbSize16);
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (i) {
                    case R.id.rbSize6:
                        ...
                        break;
                    case R.id.rbSize8:
                        String selected_size8 = size8.getText().toString();
                        selectedSize.setText(selected_size8);
                        Psize = 260;
                        break;
                    case R.id.rbSize10:
                    ...
                    case R.id.rbSize12:
                        ...
                        break;
                    case R.id.rbSize14:
                        String selected_size14 = size14.getText().toString();
                        selectedSize.setText(selected_size14);
                        Psize = 550;
                        break;
                    case R.id.rbSize16:
                        String selected_size16 = size16.getText().toString();
                        selectedSize.setText(selected_size16);
                        Psize = 650;
                        break;
                }
            }
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Value of the Psize
                String stotal = String.valueOf(Psize);

                Intent intent = new Intent(CustomRollCakeActivity.this,ConfirmationRollCakeActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CustomRollCakeActivity.this, CustomActivity.class);
                startActivity(intent);
            }
        });
