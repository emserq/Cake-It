...
public class AdminSelectedRollCake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_selected_roll_cake);

        whole = findViewById(R.id.whole);

        cakeImage = findViewById(R.id.ivShowRollCakeImage);
        cakeName = findViewById(R.id.tvShowRollCakeName);
        cakeDescription = findViewById(R.id.tvShowRollCakeDescription);
        cakePrice = findViewById(R.id.tvShowRollCakePrice);
        ...
        editCakeImage = findViewById(R.id.ivEditRollCakeImage);
        editCakeName = findViewById(R.id.etEditRollCakeName);
        editCakeDescription = findViewById(R.id.etEditRollCakeDescription);
        editCakePrice = findViewById(R.id.etEditRollCakePrice);
        ...
        FirebaseDatabase.getInstance().getReference("Collection").child("Roll Cakes").child(cakeID).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference("Collection").child("Roll Cakes").child(cakeID).removeValue();
                Toast.makeText(AdminSelectedRollCake.this, "Cake successfully deleted", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(AdminSelectedRollCake.this, AdminManageRollCakeActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseStorage.getInstance().getReference().child("RollCakesImage").child(imageUrl.getLastPathSegment())
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Task<Uri> downloadUri = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                ...
                                FirebaseDatabase.getInstance().getReference("Collection").child("Roll Cakes").child(UP_CAKEID).setValue(updatedCake).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {

                                        if (task.isSuccessful()) {
                                            Toast.makeText(AdminSelectedRollCake.this, "Roll Cake updated successfully", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(AdminSelectedRollCake.this, AdminSelectedCake.class);
                                            startActivity(intent);
                                            finish();

                                        } else {
                                            Toast.makeText(AdminSelectedRollCake.this, "There is an error!", Toast.LENGTH_SHORT).show();
                                        }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminSelectedRollCake.this, AdminHomeActivity.class);
        startActivity(intent);
    }
